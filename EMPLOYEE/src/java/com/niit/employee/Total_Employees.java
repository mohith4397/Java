 ...
 * @author mohith
 */
@WebServlet(name = "Total_Employees", urlPatterns = {"/Total_Employees"})
public class Total_Employees extends HttpServlet 
{
    public void doGet(HttpServletRequest req,HttpServletResponse res)throws IOException, ServletException
    {
        ...
        try
        {
            ...
            out.println("<b>1. Total Employees</b><br><br>");
             out.println(" <table><th>Total Employees</th>");
            while(rs.next())
            {
